 ...
 * 
 * @see <a href="http://www.flarm.com/support/manual/FLARM_DataportManual_v6.00E.pdf">FLARM data port specification</a>
 * @author wbuczak
 */
public enum AircraftType {

	UNKNOWN(0), GLIDER(1), TOW_PLANE(2), HELICOPTER_ROTORCRAFT(3), PARACHUTE(4), DROP_PLANE(5), HANG_GLIDER(
			6), PARA_GLIDER(7), POWERED_AIRCRAFT(
					8), JET_AIRCRAFT(9), UFO(10), BALLOON(11), AIRSHIP(12), UAV(13), STATIC_OBJECT(15);
