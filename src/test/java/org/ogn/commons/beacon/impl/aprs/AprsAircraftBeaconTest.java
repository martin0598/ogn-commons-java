...
public class AprsAircraftBeaconTest {
	...
	public void corrupted_beacon() {
		final String acBeacon = "F-PVVA>APRS,qAS,CHALLES:/130435h4534.95N/00559.83E'237/105/A=002818|$#*IL<&z#XLx|";
		final AircraftBeacon b1 = (AircraftBeacon) parser.parse(acBeacon);
	...
	public void corrupted_beacon2() {
		final String acBeacon = validAprs + " 33sss3 XX!~@SS id06DDEAAB +020fpm -0.7rot 53.2dB 0e +0.7kHz gps3x5";
	...
	public void test_invalid_token() {
		final AircraftBeacon aircraft_beacon = (AircraftBeacon) parser.parse(validAprs + " notAValidToken");
		Assert.assertNull(aircraft_beacon);
	}

	private void validateBasic(AircraftBeacon aircraft_beacon) {
	...
	public void test_v026() {
		...
		final AircraftBeacon aircraft_beacon_triple = (AircraftBeacon) parser
				.parse(validAprs + " id093D0930 +000fpm +0.0rot");
		final AircraftBeacon aircraft_beacon_single = (AircraftBeacon) parser.parse(validAprs + " id093D0930");
